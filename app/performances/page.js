export default function Performances () {
    return (
        <main className="performances-page">
            ...
            <p>Each semester, the Villanova Belles perform at numerous 
                events. Here are some of our performances from our first semester!</p>
            
            <section>
                <div>
                    <h2>Spring Concert 2026</h2>
